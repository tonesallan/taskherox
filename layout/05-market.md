...
>
> Código-fonte: `src/TaskHeroX.App/Views/MarketView.cs` (a tela) · `src/TaskHeroX.Core/Market/MarketDb.cs`
> (preço Steam) · `src/TaskHeroX.App/Services/OverlayService.cs` + `OverlayWindow.cs` (overlay) ·
